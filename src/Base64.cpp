...
/*
    convert 3x utf8 chars to 4x base64 chars
*/
...
/*
    convert 4x base64 chars to 3x utf8 chars
*/
...
{
    wxByte* cb = (wxByte*)wxCharBuffer(in.utf8_str().data()).release();
    ...
    return wxString((const char*)buffer, encoding);
}
